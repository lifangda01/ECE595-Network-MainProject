$(function () {
    ...
    var BasicPlayer = function () {
        ...
        function checkBuffering() {
            ...
            if (
                ...
                // if (self.LOGON) console.info("checkBuffering: buffering begin", player.currentTime);
                if (self.LOGON) console.info(player.currentTime);
            ...
            if (
                ...
                // if (self.LOGON) console.info("checkBuffering: buffering end", player.currentTime);
        ...
        function checkRendition() {
            ...
            if (lastClusterTimeStart != currentCluster.timeStart) {
                // if (self.LOGON) console.info("checkRendition: rendition =", currentCluster.rendition, 
                //                                             "timeStart =", currentCluster.timeStart,
                //                                             "timeEnd =", currentCluster.timeEnd);
                if (self.LOGON) console.info(",", currentCluster.rendition, ",", currentCluster.timeStart);
        ...
        this.getReservoirSize = function () {
            ...
            var Res = _.chain(lowClusters)
                ...
                .value() / R_avg;
            if (self.DEBUG) { console.log("getReservoirSize: Res =", Res.toFixed(2), 
                                            Math.round(Res / self.MAXBUFFERLENGTH * 100)/100) };
            return Res;
        }
        ...
        this.getNextRenditionFromChunkMap = function () {
            ...
            // Buffer Occupancy (s)
            // FIXME: change the hardcoding specific for Bourne video
            var B = [0.45, 0.60, 0.75, 0.90, 0.90]; // Bourne
            // var B = [0.30, 0.45, 0.60, 0.75, 0.90]; // Panda
            B = _.map(B, function (x) { return Math.round((x + Res)*100)/100; })
            if (self.DEBUG) { console.log("getNextRenditionFromChunkMap: B =", B) };
            var C_p, C_m;
            ...
            if (self.DEBUG) { console.log("getNextRenditionFromChunkMap: BO =", BO.toFixed(2)) };
            ...
            if (BO < B[0]) {
                ...
                if (self.DEBUG) { console.log("getNextRenditionFromChunkMap: C_f =", C_f.toFixed(2)) };
            };
        ...
        this.getNextRenditionFromRateMap = function () {
            ...
            // Bitrates (B/s)
            var R = self.avgBitrates;
            // Buffer Occupancy (s)
            // FIXME: change the hardcoding specific for Bourne video
            var B = [0.75, 0.90, 1.05, 1.20, 1.20]; // Bourne
            // var B = [0.30, 0.45, 0.60, 0.75, 0.90]; // Panda
            var R_p, R_m;
            ...
            if (self.DEBUG) { console.log("getNextRenditionFromRateMap: BO =", BO.toFixed(2)) };
            ...
            if (BO < B[0]) {
                ...
                if (self.DEBUG) { console.log("getNextRenditionFromRateMap: R_f =", R_f.toFixed(2)) };
            };
            // Returns the rendition...
    ...
    window.updatePlayer = function () {
        ...
        // var sourceFile = 'vidData/kfp/Kung_Fu_Panda';
        // var clusterData = 'vidData/kfp/Kung_Fu_Panda';
